<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=Java+Full+Stack+Developer;Backend+Specialist;Spring+Boot+%7C+Microservices+%7C+DSA;Future+Product+Engineer&center=true&width=800&height=45">
</p>
...
- 🔥 Strong in **Spring Boot, REST APIs, JWT, Microservices**
- 📊 Daily DSA + System Design Practice
- 💾 Databases: **MySQL, MongoDB**
- 🧑‍💻 Frontend: **React, HTML, CSS, JS**
- 🎯 Target: **Product-Based Company Backend Engineer**
...
|--------|------------|-------------|
| 🛒 E-Commerce System | Spring Boot, MongoDB | Order & Product Microservices |
| 🩸 Blood Bank Locator | Java, Dijkstra, MySQL | Nearest hospital finder |
| 🎵 Music Player | React, Node, MongoDB | Spotify-like web app |
...
## 🏅 Achievements  
- ✅ Built **10+ Java & Full Stack Projects**
